export const baseURL= "https://ha858aeok8.execute-api.eu-north-1.amazonaws.com/DEV/"
...
export const CALCULATOR_ULRS = {
    CALCULATE_COMPANY_EMISSION: 'CalculateCompanyEmission',
    CALCULATE_INDEVIDUAL_EMISSION: 'CalculateIndividualEmission',
