    ...
    <>
      ...
      <main className="relative min-h-screen flex flex-col md:flex-row items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${bgImg})` }}>
        <div className="flex-1 flex flex-col items-center justify-center px-4 md:px-12 lg:px-16 py-8">
          <h1 className="text-main font-bold text-4xl lg:text-5xl mb-4 md:text-left  text-center w-full max-w-lg">Take the First Step Towards Sustainability</h1>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          <Card className="bg-white rounded-3xl shadow-lg p-10 md:p-10 w-full max-w-xl">
            ...
            <CardContent className="p-0">
              <h2 className="text-lg font-semibold mb-4 text-primary  ">Sign up</h2>
