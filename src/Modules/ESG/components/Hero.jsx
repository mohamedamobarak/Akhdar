...
function Hero() {
  ...
  return (
    <section className="relative overflow-x-hidden mb-[92px] md:mb-[164px] lg:mb-[200px] ">
      <div className="absolute top-0 z-0 left-1/5 flex items-center justify-center gap-1.5">
      <img
        src={gearImg}
        className="sm:mt-8 md:mt-12 lg:mt-16 w-[14.35px] sm:w-[250px] md:w-[400.88px] lg:w-[550px]"
        alt="gear icon layer"
      />
      <img
        src={smallGear}
      ...
      <p className="text-primary font-medium lg:text-2xl md:text-xl sm:text-lg text-center m-auto max-w-[1170px] mb-[293px] leading-relaxed ">
